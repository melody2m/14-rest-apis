...
(function(module) {
  ...
  // This method is invoked on the bookView page inside initSearchFormPage function. A new object called 'book' is passed in as an argument. Bookview.initSearchResultsPage will be called as the callback function. 
  ...
  // This method is invoked inside initSearchResultsPage function. It differs from the above in that the path is more specific, targeting a single ISBN. Also, instead of calling Book.loadAll, it calls Book.create, which posts a new book into the database, rather than loading them into local objects. 
  Book.findOne = isbn =>
